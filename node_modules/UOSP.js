...
UOSP.UOSP6 = function UOSP6(){
    ...
    if (SW_new == 1) {
        for(let i=0;i<Number(roomListNum);i++){
            try{UOSP.sendKaling_notice(String(roomList[i]),"시설공사공지",String("redirect_UOS?tourl=https://www.uos.ac.kr/korNotice/view.do?list_id=FA25&seq="+adress),"","",String(title))}
            catch(e){}
        }
    }
}
