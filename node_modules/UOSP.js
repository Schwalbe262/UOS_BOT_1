...
UOSP.UOSP_deaprt_list = function UOSP_deaprt_list(room,opt){
    ...
    if(Number(opt)==1){
        ...
        let temp = "redirect_UOS?tohttps://www.uos.ac.kr/engineering/korNotice/allList.do?list_id=20013DA1&"
        link = [temp,temp,temp,temp,temp]
        mobile_link = [temp,temp,temp,temp,temp]
    }
    else if(Number(opt)==2){
        header_title = "화학공학과"
        let temp = "redirect_UOS?tohttps://www.uos.ac.kr/engineering/korNotice/allList.do?list_id=20013DA1&cate_id"
        link = [temp,temp,temp,temp,temp]
        mobile_link = [temp,temp,temp,temp,temp]
    }
    else if(Number(opt)==3){
        header_title = "기계정보공학과"
        let temp = "redirect_UOS?tohttps://www.uos.ac.kr/engineering/korNotice/allList.do?list_id=20013DA1&cate_id2=000010059&epTicket=INV"
        link = [temp,temp,temp,temp,temp]
        mobile_link = [temp,temp,temp,temp,temp]
    }
        ...
        header_title = "신소재공학과"
        let temp = "redirect_UOS?tohttps://www.uos.ac.kr/engineering/korNotice/allList.do?list_id=20013DA1&cate_id2=000010061&epTicket=INV"
        link = [temp,temp,temp,temp,temp]
        mobile_link = [temp,temp,temp,temp,temp]
    }
    else if(Number(opt)==5){
        header_title = "토목공학과"
        let temp = "redirect_UOS?tohttps://www.uos.ac.kr/engineering/korNotice/allList.do?list_id=20013DA1&cate_id2=000010382&epTicket=INV"
        link = [temp,temp,temp,temp,temp]
        mobile_link = [temp,temp,temp,temp,temp]
    }
    else if(Number(opt)==6){
        header_title = "컴퓨터과학부"
        let temp = "redirect_UOS?tohttps://www.uos.ac.kr/engineering/korNotice/allList.do?list_id=20013DA1&cate_id2=000010383&epTicket=INV"
        link = [temp,temp,temp,temp,temp]
        mobile_link = [temp,temp,temp,temp,temp]
    }
    else if(Number(opt)==7){
        header_title = "경영학부"
        let temp = "redirect_UOS?tohttps://biz.uos.ac.kr/korNotice/list.do?list_id=20008N2&epTicket=INV"
        link = [temp,temp,temp,temp,temp]
        mobile_link = [temp,temp,temp,temp,temp]
    }
    else if(Number(opt)==8){
        header_title = "행정학과"
        let temp = "redirect_UOS?tohttps://social.uos.ac.kr/social/korNotice/allList.do?list_id=econo01&cate_id2=000100002"
        link = [temp,temp,temp,temp,temp]
        mobile_link = [temp,temp,temp,temp,temp]
    }
    else if(Number(opt)==9){
        header_title = "국제관계학과"
        let temp = "redirect_UOS?tohttps://social.uos.ac.kr/social/korNotice/allList.do?list_id=econo01&cate_id2=000010055&epTicket=ST-331538-EvseKnaZmrZZC4THhvDFMXvsK0UJXZfgCVQ-22"
        link = [temp,temp,temp,temp,temp]
        mobile_link = [temp,temp,temp,temp,temp]
    }
    else if(Number(opt)==10){
        header_title = "경제학부"
        let temp = "redirect_UOS?tohttps://social.uos.ac.kr/social/korNotice/allList.do?list_id=econo01&cate_id2=000010057&epTicket=ST-331566-BHszXHC0b5FdFp1RjlWhASutG0tvCmiNkIE-22"
        link = [temp,temp,temp,temp,temp]
        mobile_link = [temp,temp,temp,temp,temp]
    }
    else if(Number(opt)==11){
        header_title = "사회복지학과"
        let temp = "redirect_UOS?tohttps://social.uos.ac.kr/social/korNotice/allList.do?list_id=econo01&seq=1946&sort=0&pageIndex=1&searchCnd=&searchWrd=&viewAuth=Y&cate_id2=000010072&epTicket=ST-331596-moOaQeUAwN1abnAplueCx7KOeWTjskUrALK-22"
        link = [temp,temp,temp,temp,temp]
        mobile_link = [temp,temp,temp,temp,temp]
    }
    else if(Number(opt)==12){
        header_title = "세무학과"
        let temp = "redirect_UOS?tohttps://social.uos.ac.kr/social/korNotice/allList.do?list_id=econo01&seq=1958&sort=0&pageIndex=1&searchCnd=&searchWrd=&viewAuth=Y&cate_id2=000010074&epTicket=ST-331603-QDYHuHqTOlcLyAXnnIYRKWTORGh77Cw2kj6-22"
        link = [temp,temp,temp,temp,temp]
        mobile_link = [temp,temp,temp,temp,temp]
    }
    else if(Number(opt)==13){
        header_title = "영어영문학과"
        let temp = "redirect_UOS?tohttps://liberalarts.uos.ac.kr/liberalarts/korNotice/allList.do?list_id=human01&cate_id2=000010067&epTicket=ST-333550-w5Rdf3z0tynxbd3zSvvEs4EvNci7trL1Gdu-22"
        link = [temp,temp,temp,temp,temp]
        mobile_link = [temp,temp,temp,temp,temp]
    }
    else if(Number(opt)==14){
        header_title = "국어국문학과"
        let temp = "redirect_UOS?tohttps://liberalarts.uos.ac.kr/liberalarts/korNotice/allList.do?list_id=human01&seq=1290&sort=0&pageIndex=1&searchCnd=&searchWrd=&viewAuth=Y&cate_i"
        link = [temp,temp,temp,temp,temp]
        mobile_link = [temp,temp,temp,temp,temp]
    }
    else if(Number(opt)==15){
        header_title = "국사학과"
        let temp = "redirect_UOS?tohttps://liberalarts.uos.ac.kr/liberalarts/korNotice/allList.do?list_id=human01&cate_id2=000010069&epTicket=ST-333599-I6bPbbT4PDKAegNJkBxmuFMfa24L6lXWr4e-22"
        link = [temp,temp,temp,temp,temp]
        mobile_link = [temp,temp,temp,temp,temp]
    }
    else if(Number(opt)==16){
        header_title = "철학과"
        let temp = "redirect_UOS?tohttps://liberalarts.uos.ac.kr/liberalarts/korNotice/allList.do?list_id=human01&cate_id2=000010070&epTicket=ST-333607-M0RciE4jasXGDNYqS3ZXZdjdFhTjk9qUzBD-22"
        link = [temp,temp,temp,temp,temp]
        mobile_link = [temp,temp,temp,temp,temp]
    }
    else if(Number(opt)==17){
        header_title = "중국어문화학과"
        let temp = "redirect_UOS?tohttps://liberalarts.uos.ac.kr/liberalarts/korNotice/allList.do?list_id=human01&seq=1286&sort=0&pageIndex=1&searchCnd=&searchWrd=&viewAuth=Y&cate_id2=000011580&epTicket=ST-333976-ZiTe1l0aw7RJgch30bDdX2zIkPWeEEbsUwL-22"
        link = [temp,temp,temp,temp,temp]
        mobile_link = [temp,temp,temp,temp,temp]
    }
    else if(Number(opt)==18){
        header_title = "수학과"
        let temp = "redirect_UOS?tohttps://science.uos.ac.kr/science/korNotice/allList.do?list_id=scien01&seq=1021&sort=0&pageIndex=1&searchCnd=&searchWrd=&viewAuth=Y&cate_id2=000010064&epTicket=ST-333692-xcUka6iAdTHnhtkxaVdjf46JiCaasAbHX5O-22"
        link = [temp,temp,temp,temp,temp]
        mobile_link = [temp,temp,temp,temp,temp]
    }
    else if(Number(opt)==19){
        header_title = "통계학과"
        let temp = "redirect_UOS?tohttps://science.uos.ac.kr/science/korNotice/allList.do?list_id=scien01&seq=1018&sort=0&pageIndex=1&searchCnd=&searchWrd=&viewAuth=Y&cate_id2=000010063&epTicket=ST-333718-f5CobZcYSO7AaYLfnO3joJTx6TKEcfaOIwT-22"
        link = [temp,temp,temp,temp,temp]
        mobile_link = [temp,temp,temp,temp,temp]
    }
    else if(Number(opt)==20){
        header_title = "물리학과"
        let temp = "redirect_UOS?tohttps://science.uos.ac.kr/science/korNotice/allList.do?list_id=scien01&cate_id2=000010065&epTicket=ST-333724-AsMdLBru9Tz6Ofk979Y1qKAkUcdg6OQhmQE-22"
        link = [temp,temp,temp,temp,temp]
        mobile_link = [temp,temp,temp,temp,temp]
    }
    else if(Number(opt)==21){
        header_title = "생명과학과"
        let temp = "redirect_UOS?tohttps://science.uos.ac.kr/science/korNotice/allList.do?list_id=scien01&cate_id2=000010066&epTicket=ST-333733-vkgXVJerAgWeP0fliXKt6CfGcqY5BvQb7Hf-22"
        link = [temp,temp,temp,temp,temp]
        mobile_link = [temp,temp,temp,temp,temp]
    }
    else if(Number(opt)==22){
        header_title = "환경원예학과"
        let temp = "redirect_UOS?tohttps://science.uos.ac.kr/science/korNotice/allList.do?list_id=scien01&seq=1022&sort=0&pageIndex=1&searchCnd=&searchWrd=&viewAuth=Y&cate_id2=000010062&epTicket=ST-333843-rWLpoZihcm6o07bbaib0JqFnTyMlkIvPosn-22"
        link = [temp,temp,temp,temp,temp]
        mobile_link = [temp,temp,temp,temp,temp]
    }
